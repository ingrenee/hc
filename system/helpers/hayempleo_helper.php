...

{
		 ...
		 $filepath=str_replace('system','application',BASEPATH.'web/cache/'.md5(base_url('')));
			...
			if(file_exists($filepath)):
		            ...
		            log_message('error', "Cache deleted for: ".$filepath);

			else:
			log_message('error', "no puede actualizar Cache deleted for: ".$filepath);
...
//	exit();
		...
		$filepath=str_replace('system','application',BASEPATH.'web/cache/'.md5($url));
			...
			log_message('debug', "no puede actualizar  oferta Cache deleted for: ".$filepath);
