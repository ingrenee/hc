...
class login_auth
{
	...
	{
		return $this->ci->login_auth_model->login($identity, $password);
	}
	...
	public function logout()
	{
		...
		$this->ci->native_session->unset_userdata('login_datos');
	...
	{
	    //$identity = $this->ci->config->item('identity');
		//var_dump($this->ci->native_session->userdata('login_datos'));
		return ($this->ci->native_session->userdata('login_datos')) ? true : false;
	}
	

	public function set($t)
	{
		return $this->ci->native_session->set_userdata('login_datos',$t);
		}	
	public function data()
	{
		return $this->ci->native_session->userdata('login_datos');
		}
