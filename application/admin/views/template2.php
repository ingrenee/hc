...
<link href="<?PHP echo base_url('html/css/haycursos.css')?>" rel="stylesheet" type="text/css" />
...
<div class="pagina">
  <div id="subcabeza">
  <h1><a href="<?PHP echo base_url('index.php');?>">HayCursos.com</a></h1>
  <h2>El portal de cursos del Perú
  </h2>
  </div>
...
<a href="<?PHP echo base_url('hayempleo/about');?>">Sobre HayEmpleo.com</a> | 
