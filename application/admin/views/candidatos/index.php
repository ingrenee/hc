...
<div class="curriculum corto">
<div class="fila  titulo " style="padding-bottom:10px; display:block;  text-align:center;"><h1 style="font-size:17px;">
<?PHP  echo (isset($general['nombres']))?$general['nombres']:'No especifica';?></h1> </div>
<div class="bloque">
...
$h=tmp(@$general['distrito']);
 ...
 ?>
    ...
    <td width="108" align="center" valign="top"><img src="<?PHP _foto($ID);?>">
    </td>
  </tr>
</table>
