...
<link href="<?PHP echo _path().('css/login-admin-subdominios.css')?>" rel="stylesheet" type="text/css" />
<link href="<?PHP echo _path().('css/contenidos.css')?>" rel="stylesheet" type="text/css" />
...
<div  ID="c1">
<h3>
Usted llego a hayempleo.com por medio del nuestro canal: <br />
<a href="http://<?PHP echo $canal?>.hayempleo.com"><span> &raquo;<?PHP echo $canal;?></span></a> </h3>
...
<div id="c2">
  <?PHP if(isset($widgets2)):?><div class="widgets">
<?PHP echo $widgets2;?></div>
...
<?PHP if($h=='welcome'):?>
    <a href="<?PHP echo base_url('index.php/registro/registrar');?>" class="boton01 flecha">      &raquo;Registrate</a>
    <?PHP else:?>
    <a href="<?PHP echo site_url('welcome/login/'.$canal);?>" class="boton01 flecha">      &raquo;Ingresa</a>
    
    <?PHP endif;?>
    
     <a href="<?PHP echo base_url('');?>" class="boton01 flecha">      &raquo;Empleos/trabajos</a>
     
       <a href="<?PHP echo base_url('index.php/registro/recuperar');?>" class="boton02">      &raquo;Recuperar contraseña</a>
...
<?PHP if(isset($widgets)):?><div class="widgets">
<?PHP echo $widgets;?></div>
<?PHP endif;?>
...
<div class="pie">
<div class="pagina">
<a href="http://www.hayempleo.com">@2012 HayEmpleo.com</a>
</div>
</div>
</body>
</html>